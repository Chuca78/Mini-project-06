...
function defaultWeather() {
    ...
    fetch('http://api.openweathermap.org/data/2.5/weather?q=Charlotte&exclude=hourly,minutely&units=imperial&' + APIkey).then(res => res.json()).then(data => {
...
form.addEventListener("submit", e => {
    ...
    fetch('http://api.openweathermap.org/data/2.5/weather?q=' + inputVal + '&exclude=hourly,minutely&units=imperial&' + APIkey).then(res => res.json()).then(data => {
...
function forecastWeather(){
    ...
    fetch('http://api.openweathermap.org/data/2.5/forecast?q='+ inputVal + '&exclude=hourly,minutely&units=imperial&' + APIkey).then(res => res.json()).then(data => {
